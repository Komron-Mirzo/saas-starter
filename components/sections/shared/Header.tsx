...
export function Header() {
  ...
  return (
    <header className="border-b border-border bg-[#F3F3F3] relative">
      ...
      <div className="max-w-[1870px] mx-auto px-[25px] py-[20px] grid grid-cols-[auto_1fr] min-[1201px]:grid-cols-[auto_1fr_auto] items-center gap-6 max-md:p-[10px]">
      ...
      <div 
        className={`fixed inset-0 z-50 bg-[#F3F3F3] flex flex-col px-[25px] py-[20px] overflow-hidden max-md:p-[10px] transition-all duration-300 ease-in-out transform ${
          mobileMenuOpen 
