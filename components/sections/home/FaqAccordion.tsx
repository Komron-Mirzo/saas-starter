...
export default function FaqAccordion({ faqs }: FaqAccordionProps) {
  ...
  return (
    <section className="w-full max-w-[1560px] py-20 px-6 md:px-12 mx-auto flex flex-col lg:flex-row justify-between items-start gap-12">
      ...
      <div className="w-full lg:max-w-[641px] flex flex-col">
        ...
        {/* Heading */}
        <h2 className="text-h1-02 text-[#1b1b1b] mb-[60px] leading-tight">
