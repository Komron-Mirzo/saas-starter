    ...
    >
      ...
      >
        <div className="pointer-events-none absolute inset-0 flex select-none items-center justify-center max-[768px]:items-start max-[768px]:top-[10%]">
          <span className="text-h1-01 !text-[42vw] max-[1500px]:!text-[55vw] max-[500px]:!text-[57.5vw] leading-none text-[#D9D9D9] ">
            {cards[activeIndex]?.number || "01"}
          </span>
        </div>
        <div className="relative h-[60vh] w-full max-w-[834px] max-[1024px]:max-w-[461px] max-h-[564px] -mb-[434px] max-[768px]:-mb-[34px] max-[768px]:max-w-[344px] max-[500px]:max-w-[280px] max-[500px]:h-[433px]">
          {cards.map((card, i) => (
            <StackCard
              key={card.number + i}
              data={card}
